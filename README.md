...
- Passengers and drivers can use PesaRide App to update their real-time location. passengers can ping a driver's GPS coordinates.
- Passengers can use PesaRide App to submit their trip request.
- Passengers and drivers can request a ride status update
